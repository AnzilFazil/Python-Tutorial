...
class SquareRootCalculator(EasyFrame):
    def __init__(self):
        ...
        self.addLabel("Enter a number:", row=0, column=0)
        self.inputField = self.addFloatField(0.0, row=0, column=1)
    ...
    def computeSqrt(self):
        ...
        try:
            ...
            self.messageBox("Error", "Please enter a valid non-negative number.")
